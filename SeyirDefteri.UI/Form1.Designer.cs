namespace SeyirDefteri.UI
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			// cmbGemi
			// 
			this.cmbGemi.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			...
			// dtpLimanCikisTarihi
			// 
			this.dtpLimanCikisTarihi.CustomFormat = "dd/MM/yyyy HH:mm";
			this.dtpLimanCikisTarihi.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
			...
			// dtpLimanVarisTarihi
			// 
			this.dtpLimanVarisTarihi.CustomFormat = "dd/MM/yyyy HH:mm";
			this.dtpLimanVarisTarihi.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
			...
			// cmnCikisLimani
			// 
			this.cmnCikisLimani.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			...
			// cmnUgradigiLimani
			// 
			this.cmnUgradigiLimani.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			...
			// cmnVarisLimani
			// 
			this.cmnVarisLimani.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			...
			// btnGec
			// 
			this.btnGec.BackColor = System.Drawing.SystemColors.Highlight;
